        ...
        <div class="maincard">
            ...
            <div class="aboutdiv">
                ...
                <div class="aboutinfo1">
                    ...
                    Projectleider THuisduinen 2050
                    </h3>
                    <p>
                    "THuisduinen2050 is een uniek project. 
                    Alle sociaal-maatschappelijke facetten komen samen en worden aangepakt. 
                    De kracht zit in de verbinding van de projecten en in het feit dat het hele project vanuit de bewoners wordt gedragen. 
                    Daarom heb ik mij hier aan verbonden!"
                    </p>
                </div>
                <div class="aboutinfo2">
                    <h3>André Schutte <br><br>
                    Bewoner en verbinder
                    </h3>
                    <p>

                    </p>
                </div>
                <div class="aboutinfo3">
                    <h3>Kyona Donkers <br><br>
                    Ondersteuning communicatie 
                    </h3>
                    <p>
                    "Vanuit mijn werk bij Tech@Connect  waarbij wij 'de regio als klaslokaal' willen inzetten kwam ik bij THuisduinen 2050 terecht. 
                    Een unieke kenniswerkplaats waarbij studenten direct hun kennis en vaardigheden kunnen inzetten
                     en daarbij ook maatschappelijk betrokken zijn!"
                    </p>
                </div>
