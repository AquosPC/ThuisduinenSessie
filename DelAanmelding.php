...
<body class="pageBG">
    ...
    <div class="maincard">
        ...
        <div class="buttoncenter"><a href="http://localhost/ThuisduinenSessie/Aanmelding.php"><button class="button">Nee, breng me terug!</button></div></a>
    </div>
    <div class="maincard">
        <h1 class="textcenter"><?php echo $row['Naam'] ?></h1>
        <h1 class="textcenter"><?php echo $row['Email'] ?></h1>
    </div>
    <div class="maincard deletediv buttoncenter">
        <form action="INC/PHP/aanmelding.delete.inc.php" method="post">
