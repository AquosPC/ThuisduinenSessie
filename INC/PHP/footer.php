  ...
  <footer class="site-footer">
      <div class="container">
        ...
        <hr>
        <p>Additional links: <a class="links" href="http://localhost/ThuisduinenSessie/Admin.php">Adminpaneel</a> &bull; <a class="links" href="http://localhost/ThuisduinenSessie/Login.php">Login</a> </p>
      </div>
</footer>